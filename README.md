[Ziphil](https://github.com/Ziphil)さんに許可をもらって開発(している|する予定の)、Ziphilさんらによる人工言語辞書アプリ[ZpDIC online](http://zpdic.ziphil.com)の派生アプリです。さらなる派生アプリの開発は都度[Ziphil](https://github.com/Ziphil)さんの許可がいります
